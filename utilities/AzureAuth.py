...
class AzureAuth(object):
    ...
    def __init__(self):
        ...
        self.url = "https://{}.blob.core.windows.net".format(
            os.getenv("STORAGE_ACCOUNT_NAME")
        )
        self.oauth_url = "https://{}.blob.core.windows.net".format(
    ...
    def auth_connection_string(self):
        ...
        self.account_info = self.blob_service_client.get_account_information()
